    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md" action="/?page=sign_up" method="POST">
            ...
            <div class="flex items-center justify-center mt-6">
                <a href="/?page=sign_in" class="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b">
                    Zaloguj się
                </a>

                <a href="/?page=sign_up" class="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b-2 border-blue-500">
                    Zarejestruj się 
                </a>
            </div>
            ...
            <div class="relative flex items-center mt-8">
                ...
                <div class="w-full">
                    <input name="username" type="text" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Nazwa uzytkownika">
                    <?php if($message['username'] ?? null): ?>
                        <p class="absolute w-full text-center"><?php echo $message['username'] ?></p>
                    <?php endif?>
                </div>
            ...
            <div class="relative flex items-center mt-6">
                ...
                <div class="w-full">
                    ...
                    <?php if($message['email'] ?? null): ?>
                        <p class="absolute w-full text-center"><?php echo $message['email'] ?></p>
                    <?php elseif($message['userExist'] ?? null): ?>
                        <p class="absolute w-full text-center"><?php echo $message['userExist'] ?></p>
                    <?php endif?>
                </div>
            </div>
            <br>
            <div class="relative flex items-center mt-4">
                ...
                <div class="w-full">
                    ...
                    <?php if($message['password'] ?? null): ?>
                        <p class="absolute w-full text-center"><?php echo $message['password'] ?></p>
                    <?php endif?>               
                </div>
            </div>
            <br>
            <div class="relative flex items-center mt-4">
                ...
                <div class="w-full">
                    ...
                    <?php if($message['confirm_password'] ?? null): ?>
                        <p class="absolute w-full text-center"><?php echo $message['confirm_password'] ?></p>
                    <?php endif?>
                </div>
            </div>
            <br>
            <div class="mt-6">
                ...
                <div class="mt-6 text-center ">
                    <a href="/?page=sign_in" class="text-sm text-blue-400 hover:underline">
                        Masz juz konta?
                    </a>
                </div>
            </div>
