    ...
    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
        <div class="rounded-t mb-0 px-4 py-3 border-0">
            <div class="flex flex-wrap items-center">
                ...
                <h3 class="font-semibold text-base text-blueGray-700">Kategorie</h3>
                </div>
                <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                    <a href="/?module=category&page=create">
                ...
                <tbody>
                    <?php foreach ($params['data'] ?? [] as $index => $data): ?>
                        <tr>
                            ...
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center text-lg">
                               <a href="/?module=category&page=delete&id=<?= $data['id'] ?>" class="text-sm text-slate-700 hover:text-slate-500"><i class="fa-solid fa-minus"></i></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
