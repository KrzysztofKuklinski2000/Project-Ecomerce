                    ...
                    <div class="w-full flex-col justify-start items-start gap-8 flex">
                        ...
                        <div class="w-full justify-start items-start gap-7 flex sm:flex-row flex-col">
                            ...
                            <div class="w-full flex-col justify-start items-start gap-1.5 flex">
                                ...
                                <input name="building_number" type="text" class="w-full focus:outline-none text-gray-900 placeholder-gray-400 text-lg font-normal leading-relaxed px-5 py-3 rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] border border-gray-200 justify-start items-center gap-2 inline-flex" placeholder="Numer Budynku">
                            </div>
                        </div>
                    </div>
                </div>
